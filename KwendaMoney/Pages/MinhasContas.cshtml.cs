...
namespace KwendaMoney.Pages
{
    ...
    public class MinhasContasModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            // Preencher automaticamente com o nome do usuário
            NovaConta = new ContaInputModel
            {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                NovaConta.NomeTitular = usuario.Nome; // Manter o nome
                return Page();
            }
            ...
            var conta = new ContaAdmin
            {
                ...
                NomeTitular = usuario.Nome, // FORÇA nome do usuário logado
